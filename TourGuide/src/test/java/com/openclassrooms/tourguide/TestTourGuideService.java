...
public class TestTourGuideService {
	...
	public void addUser() {
		...
		User retreivedUser = tourGuideService.getUser(user.getUserName());
		User retreivedUser2 = tourGuideService.getUser(user2.getUserName());

		tourGuideService.tracker.stopTracking();

		assertEquals(user, retreivedUser);
		assertEquals(user2, retreivedUser2);
	}
...
//correction methode getprice() TripPricer
		tourGuideService.tracker.stopTracking();
