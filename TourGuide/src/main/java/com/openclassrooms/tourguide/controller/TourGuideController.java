...
public class TourGuideController {
    ...
    public String getNearbyAttractions(@RequestParam String userName) {
        ...
        return convertToJson(nearbyAttractions);
    }
    ...
    private String convertToJson(List<NearbyAttraction> nearbyAttractionsToConvert) {
        try {
            ObjectMapper mapper = new ObjectMapper();
            String nearbyAttractionsJson = mapper.writeValueAsString(nearbyAttractionsToConvert);
            return nearbyAttractionsJson;
